...
(function(){
    ...
    document.addEventListener("keydown", function(e) {
      if(e.keyCode ===  13 && window.location.href.substr(-12)=="modalOverlay"){
        ...
        if( !(document.querySelector("[name=imgurl]").value.indexOf("http://") > -1  ||  document.querySelector("[name=imgurl]").value.indexOf("https://") > -1) ){
              console.log('gerg');
            return;
        }
    ...
    document.querySelector("[name=imgurl]").addEventListener("input", function() {
    ...
    document.getElementById("addMsgForm").addEventListener("submit", function(e) {
           ...
           if(document.querySelector("[name=uploadedimg]").className === "hidden" && !(document.querySelector("[name=imgurl]").value.indexOf("http://") > -1  ||  document.querySelector("[name=imgurl]").value.indexOf("https://") > -1) ){
              return;
          }
